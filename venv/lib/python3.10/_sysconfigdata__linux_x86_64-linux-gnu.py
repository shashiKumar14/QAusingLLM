...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/home/walkingtree/llmapp/venv/bin',
 'BINLIBDEST': '/home/walkingtree/llmapp/venv/lib/python3.10',
 'BLDLIBRARY': 'libpython3.10.a',
 'BLDSHARED': 'gcc -pthread -B /home/walkingtree/llmapp/venv/compiler_compat -shared  '
              ''
              ''
              '-Wl,-rpath,/home/walkingtree/llmapp/venv/lib '
              '-Wl,-rpath-link,/home/walkingtree/llmapp/venv/lib '
              '-L/home/walkingtree/llmapp/venv/lib '
              ''
              ''
              '-Wl,-rpath,/home/walkingtree/llmapp/venv/lib '
              '-Wl,-rpath-link,/home/walkingtree/llmapp/venv/lib '
 ...
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc -pthread -B /home/walkingtree/llmapp/venv/compiler_compat',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -fwrapv -O2 -Wall '
           '-fPIC '
           '-O2   '
           '-isystem '
           '/home/walkingtree/llmapp/venv/include '
           ''
           ''
           ''
           '-fPIC '
 ...
 'CONFIGURE_CPPFLAGS': '-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem '
                       '/home/walkingtree/llmapp/venv/include '
                       '-I/home/walkingtree/llmapp/venv/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      '-Wl,-rpath,/home/walkingtree/llmapp/venv/lib '
                      '-Wl,-rpath-link,/home/walkingtree/llmapp/venv/lib '
 ...
 'CONFIGURE_LDFLAGS_NODIST': '-fno-semantic-interposition  '
                             ''
                             '-g',
 'CONFIG_ARGS': "'--prefix=/home/walkingtree/llmapp/venv'"
                "'--build=x86_64-conda_cos6-linux-gnu'"
                "'--host=x86_64-conda_cos6-linux-gnu''--enable-ipv6'"
                "'--with-ensurepip=no'"
                "'--with-tzpath=/home/walkingtree/llmapp/venv/share/zoneinfo:/home/walkingtree/llmapp/venv/share/tzinfo'"
                "'--with-computed-gotos''--with-system-ffi'"
                "'--enable-loadable-sqlite-extensions'"
                "'--with-tcltk-includes=-I/home/walkingtree/llmapp/venv/include'"
                "'--with-tcltk-libs=-L/home/walkingtree/llmapp/venv/lib "
                "-ltcl8.6 -ltk8.6''--with-platlibdir=lib''--with-lto'"
                "'--enable-optimizations'"
                "'-oldincludedir=/croot/python-split_1694437906621/_build_env/x86_64-conda_cos6-linux-gnu/sysroot/usr/include'"
                ...
                '/home/walkingtree/llmapp/venv/include '
                "-I/home/walkingtree/llmapp/venv/include'"
                "'CPP=/croot/python-split_1694437906621/_build_env/bin/cpp'"
                "'PKG_CONFIG_PATH=/home/walkingtree/llmapp/venv/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/home/walkingtree/llmapp/venv/include',
 'CONFINCLUDEPY': '/home/walkingtree/llmapp/venv/include/python3.10',
 'COREPYTHONPATH': '',
 ...
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             '-I/croot/python-split_1694437906621/work/Include -DNDEBUG '
             ...
             '/home/walkingtree/llmapp/venv/include '
             '-I/home/walkingtree/llmapp/venv/include',
 'CXX': 'g++ -pthread -B /home/walkingtree/llmapp/venv/compiler_compat',
 'DESTDIRS': '/home/walkingtree/llmapp/venv '
             '/home/walkingtree/llmapp/venv/lib '
             '/home/walkingtree/llmapp/venv/lib/python3.10 '
             '/home/walkingtree/llmapp/venv/lib/python3.10/lib-dynload',
 'DESTLIB': '/home/walkingtree/llmapp/venv/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/home/walkingtree/llmapp/venv/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/home/walkingtree/llmapp/venv/include '
                   '/home/walkingtree/llmapp/venv/include '
                   '/home/walkingtree/llmapp/venv/include/python3.10 '
                   '/home/walkingtree/llmapp/venv/include/python3.10',
 'INCLUDEDIR': '/home/walkingtree/llmapp/venv/include',
 'INCLUDEPY': '/home/walkingtree/llmapp/venv/include/python3.10',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -B /home/walkingtree/llmapp/venv/compiler_compat -shared',
 'LDFLAGS': ''
            ''
            '-Wl,-rpath,/home/walkingtree/llmapp/venv/lib '
            '-Wl,-rpath-link,/home/walkingtree/llmapp/venv/lib '
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -B /home/walkingtree/llmapp/venv/compiler_compat -shared  '
             ''
             ''
             '-Wl,-rpath,/home/walkingtree/llmapp/venv/lib '
             '-Wl,-rpath-link,/home/walkingtree/llmapp/venv/lib '
 ...
 'LDVERSION': '3.10',
 'LIBC': '',
 'LIBDEST': '/home/walkingtree/llmapp/venv/lib/python3.10',
 'LIBDIR': '/home/walkingtree/llmapp/venv/lib',
 'LIBFFI_INCLUDEDIR': '/home/walkingtree/llmapp/venv/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/walkingtree/llmapp/venv/lib/pkgconfig',
 'LIBPL': '/home/walkingtree/llmapp/venv/lib/python3.10/config-3.10-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': 'gcc -pthread -B /home/walkingtree/llmapp/venv/compiler_compat',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/home/walkingtree/llmapp/venv/lib/python3.10',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread -B /home/walkingtree/llmapp/venv/compiler_compat',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': '/croot/python-split_1694437906621/work/Modules/makesetup',
 'MANDIR': '/home/walkingtree/llmapp/venv/share/man',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/home/walkingtree/llmapp/venv/include',
 'OPENSSL_LDFLAGS': '-L/home/walkingtree/llmapp/venv/lib',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG '
                             ...
                             '-fvisibility=hidden  '
                             ''
                             '-I/croot/python-split_1694437906621/work/Include/internal '
                             '-IObjects -IInclude -IPython -I. '
                             '-I/croot/python-split_1694437906621/work/Include '
                             '-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem '
                             '/home/walkingtree/llmapp/venv/include '
                             '-I/home/walkingtree/llmapp/venv/include '
                             '-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/home/walkingtree/llmapp/venv/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TCLTK_INCLUDES': '-I/home/walkingtree/llmapp/venv/include',
 'TCLTK_LIBS': '-L/home/walkingtree/llmapp/venv/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': './python '
               '/croot/python-split_1694437906621/work/Tools/scripts/run_tests.py',
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/home/walkingtree/llmapp/venv/share/zoneinfo:/home/walkingtree/llmapp/venv/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 ...
 'datarootdir': '/home/walkingtree/llmapp/venv/share',
 'exec_prefix': '/home/walkingtree/llmapp/venv',
 'prefix': '/home/walkingtree/llmapp/venv',
 'srcdir': '/croot/python-split_1694437906621/work'}
